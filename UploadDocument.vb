...
Module Module_UploadDocument

    Sub UploadDocument(ByVal ServiceURL As String, ByVal AuthenticationTicket As String, ByVal uploadpath As String, ByVal LocalFilePath As String)
