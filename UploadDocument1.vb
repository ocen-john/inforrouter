...
Module Module_UploadDocument1

    Sub UploadDocument1(ByVal ServiceURL As String, ByVal AuthenticationTicket As String)
        ...
        Try
            If System.IO.File.Exists(LocalFilePath) Then
                ...
                'call upload method
                Dim xml_response As System.Xml.XmlNode = IR_OBJ.UploadDocument1(AuthenticationTicket, uploadpath, buffer, VersionComment)
